  ...
  return (
    <section className="relative flex min-h-[100svh] items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 py-16 text-center md:px-6 md:py-0">
        ...
        <h1 className="mb-3 bg-gradient-to-r from-gold-primary to-gold-light bg-clip-text font-[family-name:var(--font-heading)] text-[clamp(1.8rem,10vw,5.5rem)] font-bold text-transparent leading-[1.1] md:mb-4">
        ...
        <div className="flex flex-col gap-3 md:flex-row md:flex-wrap md:justify-center md:gap-4">
          ...
          <a
            ...
            className="relative group overflow-hidden inline-flex items-center justify-center gap-2 bg-[#25D366] px-6 py-3.5 font-[family-name:var(--font-heading)] text-[0.85rem] font-bold uppercase tracking-wider text-white shadow-lg transition-all hover:scale-105 active:scale-95 md:px-8 md:py-4 md:text-sm"
          >
