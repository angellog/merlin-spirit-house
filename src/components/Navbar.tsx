...
export default function Navbar() {
  ...
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-[9999] border-b border-white/5 bg-elevated backdrop-blur-md"
    >
      ...
      {mobileOpen && (
        <div
          className="fixed inset-0 top-0 z-[10000] flex flex-col bg-deepnight lg:hidden"
        >
