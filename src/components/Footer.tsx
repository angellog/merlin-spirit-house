...
export default function Footer() {
  return (
    <footer className="border-t border-gold-dim bg-elevated">
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-6 md:py-16">
        <div className="grid gap-8 md:grid-cols-2 md:gap-12 lg:grid-cols-4">
          <div>
            <Link
              href="/"
              className="flex items-center gap-2 text-lg font-[family-name:var(--font-heading)] font-bold text-gold-primary"
            >
            ...
            <div className="mt-6 flex gap-4">
              <a
                ...
                className="text-text-muted transition-colors hover:text-gold-primary"
                aria-label="WhatsApp"
              >
          ...
          <div>
            <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-text-primary md:mb-4 md:text-sm">
              Services
            </h3>
            <ul className="flex flex-col gap-2 md:gap-3">
              {serviceLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-xs text-text-muted transition-colors hover:text-gold-primary md:text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-xs text-text-muted md:gap-3 md:text-sm">
              <li>
