...
export default function MobileStickyBar() {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 flex h-14 items-center justify-between px-4 md:hidden"
      style={{ zIndex: 9998, background: "var(--color-gold-primary)" }}
    >
      <span className="text-[0.8rem] font-semibold text-[#0A0A12]">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded-full px-3 py-1.5 text-[0.8rem] font-semibold text-[#0A0A12] transition-all hover:brightness-110"
