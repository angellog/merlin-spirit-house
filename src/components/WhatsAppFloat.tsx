  ...
  return (
    <div className="fixed right-4 bottom-[180px] md:bottom-[28px] md:right-[28px]" style={{ zIndex: 9999 }}>
      {showTooltip && (
        ...
        >
          Chat with {clientTitle} {clientName}
        </div>
      )}
      <a
        ...
        className="flex h-[56px] w-[56px] md:h-[60px] md:w-[60px] items-center justify-center rounded-full animate-pulse-whatsapp transition-transform hover:scale-110"
