        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-24 grid gap-16 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2">
              <div className="rounded-2xl border border-gold-dim/20 bg-surface p-8">
                ...
                <div className="mt-8 space-y-6">
                  ...
                  <div>
                    <p className="text-xs uppercase tracking-wider text-text-muted">Confidentiality</p>
                    <p className="mt-1 text-sm text-text-primary">All consultations and communications are strictly confidential.</p>
                  </div>
