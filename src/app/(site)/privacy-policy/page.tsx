  ...
  return (
    <section className="py-24">
      <div className="mx-auto max-w-3xl px-6">
        ...
        <p className="mt-2 text-sm text-[var(--color-text-muted)]">Last updated: January 1, 2025</p>
        ...
        <div className="mt-12 space-y-12">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-[var(--color-text-secondary)]"><strong className="text-[var(--color-text-primary)]">Jivochat</strong> — Provides our live chat functionality. Jivochat may collect chat transcripts and basic visitor information as part of their service. Their privacy policy applies to data they collect independently.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-1 shrink-0 text-[var(--color-gold-primary)]">◈</span>
                <span className="text-[var(--color-text-secondary)]"><strong className="text-[var(--color-text-primary)]">Google Analytics</strong> — Helps us understand website traffic and usage patterns through anonymized data. Google Analytics uses cookies to collect information about how visitors use our site. This data is aggregated and does not personally identify individual visitors.</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h2>Contact</h2>
            <p className="mt-4 text-[var(--color-text-secondary)] leading-relaxed">
              For any questions or concerns about this privacy policy or how your data is handled, please contact us at <a href={`mailto:${clientEmail}`} className="text-[var(--color-gold-primary)] hover:underline">{clientEmail}</a> or visit our <Link href="/contact" className="text-[var(--color-gold-primary)] hover:underline">contact page</Link>.
            </p>
          </div>
        </div>
      </div>
