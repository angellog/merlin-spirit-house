    ...
    <>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <details
                ...
                className="group rounded-xl bg-surface border border-gold-dim/20 overflow-hidden"
              >
                <summary className="flex cursor-pointer items-center justify-between gap-4 p-6 text-lg font-semibold text-text-primary font-[family-name:var(--font-heading)] transition-colors hover:text-gold-primary list-none [&::-webkit-details-marker]:hidden">
                  <span>{faq.question}</span>
                  <span className="shrink-0 text-gold-primary transition-transform group-open:rotate-45 text-2xl leading-none">+</span>
                </summary>
          ...
          <div className="mt-20 rounded-2xl bg-surface border border-gold-dim/20 p-10 text-center">
            <p className="mb-4 text-sm font-semibold uppercase tracking-[0.2em] text-gold-primary">
